...
let userData = [
  ...
  let postitem = [
    { id: 111, caption: 'funnny', posterimg: 'https://media.licdn.com/dms/image/D4D22AQHSezKUVXZgjg/feedshare-shrink_800/0/1695626939216?e=1698278400&v=beta&t=W86oLVm9Y4uNtONslgniAjz3mXccjmChQI1u0Q6zQM8' },
    { id: 222, caption: 'meme is funny', posterimg: 'https://media.licdn.com/dms/image/D4D22AQGmC-CzcOLQiw/feedshare-shrink_2048_1536/0/1695460450621?e=1698278400&v=beta&t=z5Fn8ucyaNSLmfZAkgEXJy3EJv9Dc7Vab5iNVwf5yTk' },
    { id: 333, caption: 'I’m happy to share that I’m starting a new position as Software Developer(Front-end developer) at Fabevy! #softwaredeveloper #developer', posterimg: 'https://media.licdn.com/media/AAYQAQQSAAgAAQAAAAAAACLpMhX316YdSYufJSyHsL132Q.jpg' }
  ];
  ...
  if (getUrl.includes("index.html")) {
    ...
    function addNewPost() {
      ...
      postitem.unshift(newpost);
      postload(postitem);

      // Clear the input field after adding the post
      captionInput.value = '';
	   selectedImage.src = '';
	   document.getElementsByClassName("blur")[0].removeAttribute("id", "overlay");
	  document.getElementById('show').removeAttribute("id", "show");
    }
